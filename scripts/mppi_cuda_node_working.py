...
class ControlHexarotor:
    def __init__(self):
        ...
        self.mppi_params = {
            ...
            'weights' : np.array([5200, 5200, 18200, 100, 100000, 100000, 1200000, 100, 20, 10, 10, 10, 50]), # w_pose_x, w_pose_y, w_pose_z, w_vel, w_att_roll, w_att_pitch, w_att_yaw, w_omega, w_cont, w_cont_m, w_cont_f, w_cont_M, w_terminal
    ...
    def normalize_control_inputs_lqr(self, control_inputs, gravity_vector_body):
        ...
        control_inputs[0] = control_inputs[0] / (29.64)
        control_inputs[1] = control_inputs[1] / (26.96) 
        control_inputs[2] = control_inputs[2] / (61.78) * 1.2
