...
def dynamics_update_sim(x, u, dt, inertia_mass):
...
if __name__ == "__main__":
    ...
    mppi_params = dict(
        ...
        weights = np.array([500, 500, 500, 1, 75000, 75000, 75000, 100, 4, 10, 1, 1, 1]), # w_pose_x, w_pose_y, w_pose_z, w_vel, w_att_roll, w_att_pitch, w_att_yaw, w_omega, w_cont, w_cont_m, w_cont_f, w_cont_M, w_terminal
    ...
    for t in range(max_steps):
        ...
        xhist[t+1, :] = dynamics_update_sim(xhist[t, :], u_curr, cfg.dt, mppi_params['inertia_mass'])
        # print("x: ", xhist[t+1, :])
        print(t)
