 ...
 * 
 *  Matrix containing 10 reference/measurement vectors of size 18 for first 10 nodes.
 */
real_t y[ 180 ];
...
/** Matrix of size: 4 x 228 (row major format) */
real_t rk_kkk[ 912 ];
...
/** Matrix of size: 660 x 6 (row major format) */
real_t E[ 3960 ];
